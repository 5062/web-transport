...
## [0.4.0](https://github.com/moq-dev/web-transport/compare/web-transport-trait-v0.3.7...web-transport-trait-v0.4.0) - 2026-07-29
...
- *(qmux)* honor per-stream send priority (sendOrder) ([#246](https://github.com/moq-dev/web-transport/pull/246))
...
- Fix default read_chunk() implementation ([#105](https://github.com/moq-dev/web-transport/pull/105))

## [0.1.1](https://github.com/moq-dev/web-transport/compare/web-transport-trait-v0.1.0...web-transport-trait-v0.1.1) - 2025-09-03
